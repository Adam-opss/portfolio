...
const copy = {
  en: {
    ...
    anomalyEyebrow: "05 · Anomaly taxonomy",
    anomalyTitle: "Three kinds of anomalies",
    anomalyBody:
      "The pipeline distinguishes three anomaly types, because each tells an investigator a different story:",
    anomalies: [
      {
        img: "/thesis/point-anomaly.png",
        title: "Point anomaly",
        desc: "A single pair sits far away from the population on one metric: an isolated red flag.",
      },
      {
        img: "/thesis/contextual-anomaly.png",
        title: "Contextual anomaly",
        desc: "A value that is normal globally but abnormal in its context (sector, size, time).",
      },
      {
        img: "/thesis/collective-anomaly.png",
        title: "Collective anomaly",
        desc: "Individually unremarkable observations that are suspicious as a sequence, like alternating wins.",
      },
    ],
  ...
  sk: {
    ...
    anomalyEyebrow: "05 · Typológia anomálií",
    anomalyTitle: "Tri druhy anomálií",
    anomalyBody:
      "Pipeline rozlišuje tri typy anomálií, pretože každý hovorí vyšetrovateľovi iný príbeh:",
    anomalies: [
      {
        img: "/thesis/point-anomaly.png",
        title: "Bodová anomália",
        desc: "Jedna dvojica leží ďaleko od populácie v jednej metrike: izolovaná červená vlajka.",
      },
      {
        img: "/thesis/contextual-anomaly.png",
        title: "Kontextová anomália",
        desc: "Hodnota globálne normálna, ale abnormálna vo svojom kontexte (sektor, veľkosť, čas).",
      },
      {
        img: "/thesis/collective-anomaly.png",
        title: "Kolektívna anomália",
        desc: "Jednotlivo nenápadné pozorovania, ktoré sú podozrivé ako sekvencia, napríklad striedanie výhier.",
      },
    ],
